...
public class Products extends BaseClass {
    ...
    public void singleProduct() throws Exception {
        if (ConfigReader.isMocked()) configureStubForSuccessWithJsonBody("/products/1", "MockResponses/SingleProduct.json");
    ...
    public void multipleProducts() throws Exception {
        if (ConfigReader.isMocked()) configureStubForSuccessWithJsonBody("/products", "MockResponses/MultipleProducts.json");
